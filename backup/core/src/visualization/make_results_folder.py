...
# Results
from backup.results import TEMPERATURE_FIG, PRESSURE_FIG, DENSITY_FIG, VISCOSITY_FIG, WIND_FIG, ENGINE_ANGLE_FIG, \
    ...
    ACCELERATION_FIG, VELOCITY_FIG, TRAJECTORY_FIG, UNARY_RESPONSE
...
def performance_check(path: str) -> None:
...
def unary_response(path: str) -> None:
    if UNARY_RESPONSE:
        path = path + '/00_OVERVIEW'
        os.mkdir(path)
